# Reference
# - https://github.com/Pointcept/Pointcept/tree/df36980119f4636beb2d02d04ef3b2fec0fddfba/pointcept/models/point_transformer
#
...
class PointTransformer(nn.Module):
    def __init__(self, block, blocks, in_channels=6, out_channels=512):
        super().__init__()
    ...
    def forward(self, data_dict, pooling=False, return_all=False):
        p0 = data_dict["coord"]
        x0 = data_dict["feat"]
        ...
        if pooling:
            ...
            x = self.fc1(x)
            if return_all:
                return x, p5, self.fc2(x5), o5
            else:
                return x
        else:
            return p5, self.fc2(x5), o5
